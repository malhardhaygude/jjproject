...
import img from "../images/exportservice.jpg";
import img2 from "../images/importAgent.jpg";
import img3 from "../images/sourcingAgent.jpg";
          ...
          >
            <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
              ...
              <h3
                className="text-3xl  text-blue-900 
                            font-bold"
              >
                We <span className="font-black">Build</span> Trust
              </h3>
              <div>
            ...
            <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
              ...
              <h3 className="text-3xl  text-blue-900 font-bold">
                We <span className="font-black">Collaborate</span> With Businesses
              </h3>
              <div>
                <p className="my-3 text-xl text-gray-600 font-semibold">
